      ...
      <div class='mx-auto flex h-72 max-w-[700px] items-start justify-between p-10 pt-20'>
        ...
        <div class='relative'>
          <button
            ...
            class={classNames(
              'relative flex h-10 w-10 cursor-pointer select-none items-center justify-center rounded-full bg-light-hard-gray-light font-medium outline-none drop-shadow-xl transition-all duration-300 active:scale-90 dark:bg-dark-hard-desaturated-dark-blue',
